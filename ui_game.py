...
class T4Train(QtWidgets.QMainWindow):
    ...
    def __init__(self, ds_filename):
        print("I am in the beginning of T4T")
    ...
    def keyPressEvent(self, event):
        ...
        # T
            ...
            if ALGO_SUGGESTION and (suggested_algo != ALGOS[CURR_ALGO_INDEX]):
                ...
                suggestion_text = "Detected a {} ({}) amount of classes and a {} ({}) amount of instances. Recommend you use {} as the optimal algorithm.\n\nThese suggestions can be toggled in the User Interface tab.".format(
                    class_count_str, str(len(LABELS)), inst_count_str, str(INSTANCES), suggested_algo)
    ...
    def update_points(self):
        ...
        for i in range(0, CHANNELS):
            ...
            # Featurize plots
            reframe = utils.featurize(npy_data[i], featurization_type=self.feature, numbins=NUM_BINS,
    ...
    def on_retrain(self):
        ...
        # Restart ml process
        self.ml_subprocess = subprocess.Popen("python ml.py", shell=True, stdout=subprocess.PIPE,
